...
function RelatedPosts({ posts, lang }: {
  posts: { slug: string; title: string; cover_image_url: string | null; cover_focal_x: number | null; cover_focal_y: number | null; published_at: string }[];
  lang: Lang;
}) {
  return (
            ...
            {rp.cover_image_url && (
              <div className="aspect-[16/9] rounded-lg overflow-hidden mb-3">
                <Image
                  ...
                  style={{ objectPosition: `${rp.cover_focal_x ?? 50}% ${rp.cover_focal_y ?? 50}%` }}
                />
              </div>
            )}
...
export default async function BlogPostPage({
  ...
  const relatedPosts = related.map((r) => {
    ...
    return { slug: loc.slug, title: loc.title, cover_image_url: r.cover_image_url, cover_focal_x: r.cover_focal_x, cover_focal_y: r.cover_focal_y, published_at: r.published_at };
  });
        ...
        <article className="max-w-3xl mx-auto px-6">
            ...
            <FadeIn>
              <div className="aspect-[2/1] rounded-xl overflow-hidden mb-10">
                <Image
                  ...
                  style={{ objectPosition: `${post.cover_focal_x ?? 50}% ${post.cover_focal_y ?? 50}%` }}
                  priority
                />
              </div>
            </FadeIn>
          ...
          <FadeIn delay={0.15}>
            <div className="flex items-center gap-4 mb-10 pb-8 border-b border-charcoal/8">
              ...
              <span className="text-charcoal/15">&middot;</span>
